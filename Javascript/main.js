...
function mobilecheck() {
  ...
  isSmall = check || window.innerWidth <= 515;
  return check;
};
...
$(document).ready(function(){
  ...
  imageGridzPos_Y = document.getElementById("image-gridz").offsetTop;
  document.getElementById("menu-home").style.borderBottom = "rgb(82,172,230) solid 5px";

  if (mobilecheck()) {
    faqPos_Y = faqPos_Y - 40;
    contactzPos_Y = contactzPos_Y - 40;
    imageGridzPos_Y = imageGridzPos_Y - 40;
  }

  if (mobilecheck()) {
    document.getElementById("stylez").setAttribute("href", "CSS/mobile.css");
  } else {
    document.getElementById("stylez").setAttribute("href", "CSS/main.css");
  }
});
...
function change_large(imgID) {
  var gridItems = document.getElementsByClassName("image-gridz-item");
  for (var i = 0; i < gridItems.length; i++) {
    gridItems[i].setAttribute("class", "image-gridz-item small");
  }
  document.getElementById(imgID).setAttribute("class", "image-gridz-item large");
  document.body.scrollTop = imageGridzPos_Y - 70;
  document.documentElement.scrollTop = imageGridzPos_Y - 70;
}
